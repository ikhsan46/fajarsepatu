				...
				<table class="table">
					...
					<tbody>
						<?php
                            ...
                            $subtotal = 0;
                            $qproduk="SELECT p.gambar, p.nm_produk, d.harga, d.jml_order, d.diskon, d.subharga, d.size FROM tbl_detail_order d JOIN tbl_produk p ON d.id_produk=p.id_produk WHERE id_order = '$id_order'";
						...
						<tr>
							...
							<td class="text-center">Rp.
								<?php echo number_format($produk['diskon']);?> </td>
